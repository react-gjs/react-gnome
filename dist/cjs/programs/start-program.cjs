...
var import_build_program = require("./build-program.cjs");
...
var StartProgram = class extends import_build_program.BuildProgram {
  ...
  async main() {
    ...
    await this.esbuildCtx.init(
      {
        ...import_default_build_options.defaultBuildOptions,
        inject: (0, import_get_polyfills.getGlobalPolyfills)(this),
