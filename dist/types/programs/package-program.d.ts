...
declare type PackagingContext = {
  appID: string;
  appName: string;
  appVersion: string;
  packageName: string;
};
export declare class PackageProgram extends Program {
  additionalPlugins(): {};
  ...
  protected preparePoDirFiles(
    poDirPath: string,
    context: PackagingContext
  ): Promise<void>;
  protected prepareMesonDirFiles(
    mesonDirPath: string,
    context: PackagingContext
  ): Promise<void>;
  protected prepareDataDirFiles(
    dataDirPath: string,
    context: PackagingContext
  ): Promise<void>;
  protected prepareSrcDirFiles(
    srcDirPath: string,
    context: PackagingContext
  ): Promise<void>;
  protected prepareMainBuildDirFiles(
    buildDirPath: string,
    context: PackagingContext
  ): Promise<void>;
  protected prepareBuildFiles(
    appName: string,
    buildDirPath: string
