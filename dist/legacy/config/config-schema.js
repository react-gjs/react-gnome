    ...
    import_dilswer.DataType.RecordOf({
      ...
      node: (0, import_dilswer.OptionalField)(
        import_dilswer.DataType.RecordOf({
          ...
          querystring: (0, import_dilswer.OptionalField)(import_dilswer.DataType.Boolean),
          os: (0, import_dilswer.OptionalField)(import_dilswer.DataType.Boolean)
        })
      )
    })
  ),
  customPolyfills: (0, import_dilswer.OptionalField)(
    import_dilswer.DataType.ArrayOf(
      import_dilswer.DataType.RecordOf({
        filepath: import_dilswer.DataType.String,
        importName: (0, import_dilswer.OptionalField)(import_dilswer.DataType.String)
      })
    )
  ),
